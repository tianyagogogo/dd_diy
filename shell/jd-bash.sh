...
function diycron(){
    ...
    # 领现金兑换红包
    echo "0 0 * * 4,5 node /scripts/jd_cash_exchange.js >> /scripts/logs/jd_cash_exchange.log 2>&1" >> /scripts/docker/merged_list_file.sh
...
function otherreplace(){
    ...
    # 京喜财富岛提现
    #echo "59 11,12,23 * * * sleep 50; node /scripts/jd_cfdtx.js >> /scripts/logs/jd_cfdtx.log 2>&1" >> /scripts/docker/merged_list_file.sh
}
