...
function longzhuzhu_diy(){
    ...
    # 半点京豆雨
    echo "29 16-23/1 * * * sleep 58; node /scripts/jd_half_redrain.js >> /scripts/logs/jd_half_redrain.log 2>&1" >> /scripts/docker/merged_list_file.sh
}
...
# 删除和lxk重复的脚本
function removeJs(){
    rm -rf /scripts/z_marketLottery.js /scripts/z_entertainment.js /scripts/monk_skyworth_car.js /scripts/z_tcl_lining.js /scripts/z_super5g.js /scripts/monk_shop_follow_sku.js /scripts/z_city_cash.js /scripts/z_carnivalcity.js /scripts/adolf_star.js
}
